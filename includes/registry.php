...
spl_autoload_register(function($class) {
    ...
    if ( false !== strpos( $class, 'DMG\RML' ) ) {

        $dir = DMG_RML_PLUGIN_PATH . 'includes/classes/';

        $remove_classname = str_replace( 'DMG\RML\\', '', $class );
...
class Registry
{
    ...
    /**
     * Initialises the plugin by creating an instance of an empty array.
     */
    ...
    public function build_registry()
    {
        ...
        $this->add('SyncTerm', new SyncTerm());
        $this->add('I18n', new I18n());
        $this->add('TaxBlockMarker', new TaxBlockMarker());
